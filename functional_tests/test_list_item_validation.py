...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_duplicate_items(self):
        ...
        buywellies = 'Buy wellies'
        self.browser.get(self.live_server_url)
        self.get_item_input_box().send_keys(buywellies)
        self.get_item_input_box().send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table('1: {}'.format(buywellies))
    ...
    def test_error_messages_are_cleared_on_input(self):
        ...
        banter = 'Banter too thick'
        self.browser.get(self.live_server_url)
        self.get_item_input_box().send_keys(banter)
        self.get_item_input_box().send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table('1: {}'.format(banter))
        self.get_item_input_box().send_keys(banter)
        self.get_item_input_box().send_keys(Keys.ENTER)
